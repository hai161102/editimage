...
internal class MultiTouchListener(
    ...
    private inner class GestureListener : SimpleOnGestureListener() {
        ...
        override fun onLongPress(e: MotionEvent) {
            super.onLongPress(e)
//            mOnGestureControl?.onLongClick() // tientoan2503 comment
        }

        override fun onDoubleTap(e: MotionEvent?): Boolean {
            mOnGestureControl?.onLongClick() // tientoan2503 double tap for edit
    ...
    init {
        ...
        mGestureListener.setOnDoubleTapListener(GestureListener())
